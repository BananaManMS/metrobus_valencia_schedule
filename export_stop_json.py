...
def main():
    ...
    # Asegura la creación automática de .nojekyll para evitar errores de despliegue en GitHub Pages
    ...
    # Comprobación defensiva de tablas y columnas existentes en la BD
    ...
    # Selección de días de la semana desde calendar (o valor por defecto 1 si no existiera la tabla)
    calendar_select = """
